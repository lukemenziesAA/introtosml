...
# MAGIC We want to use the new violent crime feature as a label, and train a model to predict if a violent crime will occur based off: "REPORTING_AREA", "DISTRICT", "YEAR", "MONTH", "DAY_OF_WEEK", "HOUR", "UCR_PART".
