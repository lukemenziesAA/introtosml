...
# MAGIC </div>
# MAGIC
# MAGIC # *Use Feature Store*. Presented by <a href="www.advancinganalytics.co.uk">Advancing Analytics</a>
...
mlflow.lightgbm.save_model(model_uri, "dbfs:/FileStore/shared_uploads/tori@advancinganalytics.co.uk/")
mlflow.end_run()
